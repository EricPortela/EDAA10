...
public class LifeView extends Frame {
	...
	/** V�ntar tills anv�ndaren klickar med musen. Ger:
      1: Klick i ruta p� spelplanen. Index f�r rutan kan h�mtas med getRow
			och getCol
	...
	/** Tar reda p� radnummer f�r den klickade rutan efter kommando nr 1 */
	public int getRow() {
		return lastRow;
	}

	/** Tar reda p� kolonnummer f�r den klickade rutan efter kommando nr 1 */
	public int getCol() {
		return lastCol;
	}
